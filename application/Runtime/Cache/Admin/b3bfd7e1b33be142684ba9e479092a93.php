...
<div class="table-box">
	<table>
        ...
        <tbody>
        	<?php if(is_array($node_list)): $i = 0; $__LIST__ = $node_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
            	<td class="num"><?php echo ($vo["node_id"]); ?></td>
                <td class="name"><?php echo ($vo["node_name"]); ?></td>
                <td class="nickname"><?php echo ($vo["node_title"]); ?></td>
                <td class="dept"><?php echo ($vo["node_pid"]); ?></td>
                <td class="role"><?php echo ($vo["node_module"]); ?></td>
                <td class="sex"><?php echo ($vo["node_controller"]); ?></td>
                <td class="birthday"><?php echo ($vo["node_action"]); ?></td>
				<th class="tel"><?php echo ($vo["node_path"]); ?></th>
				<th class="email"><?php echo ($vo["node_level"]); ?></th>
				<th class="ctime"><?php echo ($vo["node_sort"]); ?></th>
                <td class="operate"><?php echo ($vo["node_show"]); ?></td>
...
$('button').click(function(){
	...
	location.href = "/Admin/Role/distributeOk/ids/" + str +"/rid/" + <?php echo ($_GET['rid']); ?>;
})
